      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Access To Your Data, From Anywhere, Anytime.`,
              description: `Our SEO services seamlessly integrate with a range of popular applications, ensuring your data is always up-to-date and actionable. By connecting with these tools, you can streamline your workflow, enhance reporting, and take advantage of automated actions to optimize your SEO `,
            }}
          />
