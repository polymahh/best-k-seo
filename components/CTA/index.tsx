          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join With Us Today & Start Your SEO Journey
              </h2>
              <p>
                Achieve top search rankings and drive targeted traffic with our
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                <a
                  href="signup.html"
                  className="inline-flex items-center gap-2.5 rounded-full bg-titlebg2 px-6 py-3 font-medium text-white hover:opacity-90 dark:bg-white dark:text-black"
                >
                  Get Started
                  <Image
                    width={20}
