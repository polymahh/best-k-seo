              ...
              >
                ...
                <div className="flex flex-wrap gap-4 xl:justify-between ">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full bg-titlebg2 px-6 py-3 font-medium text-white duration-300 ease-in-out hover:bg-blackho dark:bg-btndark"
                  >
                    Send Message
                    <svg
