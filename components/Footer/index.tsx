          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap justify-around gap-8 lg:gap-0">
              <motion.div
                ...
                viewport={{ once: true }}
                className="animate_top mr-auto w-full max-w-[260px]"
              >
                ...
                <p className="mb-10 mt-5">{config.siteDescription}</p>
              ...
              <div className="flex w-full flex-row flex-wrap gap-8 md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
                  ...
                  viewport={{ once: true }}
                  className="animate_top min-w-[160px]"
                >
